...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if (typeof th !== 'undefined') {
            ...
            if( th.find("#businessup_service_limit").val() == 3 )
                {
                   
                    th.parent().find(".customizer_businessup_upgrade_section").show();
                    return false;
                }
                else
                { 
                   var total_services_sections=parseInt(th.find("#businessup_service_limit").val())+1;
                   th.find("#businessup_service_limit").val(total_services_sections);
                   var limit = th.find("#businessup_service_limit").val();
                   if(limit <= 3)
                {
                    th.parent().find(".customizer_businessup_upgrade_section").hide();
                }
                } // }
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        var total_service= parseInt(this1.find("#businessup_service_limit").val())-1;
        this1.find("#businessup_service_limit").val(total_service);
        var limit = this1.find("#businessup_service_limit").val();
        if(limit <= 6)
                {
                    this1.parent().find(".customizer_fameup_upgrade_section").hide();
                }
